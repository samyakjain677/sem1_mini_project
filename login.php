...
if($_SERVER["REQUEST_METHOD"] =="POST")
{
    ...
    //$role = $_POST["role"];
    $sql ="SELECT * FROM `students` WHERE `Name` LIKE '$username' AND `password` LIKE '$password'";
        ...
        {
          /*  $sql ="SELECT * FROM `admin` WHERE `Name` LIKE '$username' AND `password` LIKE '$password'";
            $result = mysqli_query($link,$sql);
            $num = mysqli_num_rows($result);
            if($num== 1)
            {
            ...
            {*/
                $sql ="SELECT * FROM `people` WHERE `Name` LIKE '$username' AND `password` LIKE '$password'";
                $result = mysqli_query($link,$sql);
                $num = mysqli_num_rows($result);
                if($num== 1)
                {
